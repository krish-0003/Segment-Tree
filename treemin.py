...
def display():
    s1 = ""
    s1 += str("Node is Represented as: [l,r)-seg,isset,lazy")
    s1 += "\n\n\n"
    s1 += str(printnode(0, 1, 9, 65 * 3))
    s1 += "\n\n\n\n\n"
    s1 += str(printnode(1, 1, 5, 28 * 2))
    s1 += str(printnode(2, 5, 9, 28 * 2))
    s1 += "\n\n\n\n\n"
    s1 += "          "
...
ll = Label(root, text='Segment Tree For Min values(19BCE064, 19BCE072, 19BCE074)', font=("Trajan Pro", 16), justify=CENTER)
